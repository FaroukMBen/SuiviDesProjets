            ...
            <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    {COLUMNS.map((col) => {
                        ...
                        const colBgColors: Record<string, string> = {
                        ...
                        return (
                            <div
                                key={col.id}
                                className={`flex flex-col h-auto min-h-[500px] rounded-xl border shadow-sm ${colBgColors[col.id] || 'bg-gray-50/10 border-gray-200'}`}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                {COLUMNS.map((col) => {
                    ...
                    return (
                        <div
                            key={col.id}
                            className={`flex flex-col min-h-[650px] rounded-3xl border p-4 transition-all shadow-sm shadow-inner ${colBgColors[col.id] || 'bg-gray-50/80 border-gray-200/50'}`}
                            onDragOver={(e) => e.preventDefault()}
                            onDrop={(e) => handleDrop(e, col.id)}
                        >
