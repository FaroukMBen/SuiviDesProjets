                        ...
                        <div className="flex items-center gap-2">
                           ...
                           <div className="flex -space-x-2">
                              {project.members && project.members.slice(0, 3).map((m: any, idx: number) => (
                                <div key={idx} className="w-8 h-8 rounded-full bg-gray-200 border-2 border-white flex items-center justify-center text-xs font-bold text-gray-600" title={m.name}>
                                  {m.name.charAt(0)}
                                </div>
                              ))}
                          ...
                          <div className="space-y-3 animation-fade-in">
                             ...
                             <div className="flex items-center justify-between text-xs text-gray-500">
                                <div className="flex items-center gap-2">
                                  ...
                                  <span className="font-semibold text-gray-700">{evaluation?.evaluator?.name || 'Enseignant'}</span>
                                </div>
