  ...
  return (
    <div>
        ...
        <div className="flex gap-4 mb-6">
            ...
            {/* Boutons d'action : Relancer tous les manquants (simulé pour l'instant) */}
            <button className="hidden md:flex items-center gap-2 px-4 py-2 bg-white border border-gray-200 text-gray-700 font-medium rounded-xl hover:bg-gray-50 transition">
                <Mail size={18} />
                <span>Relancer tous ({pendingCount})</span>
            </button>
        </div>
