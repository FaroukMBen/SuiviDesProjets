                    ...
                    {loading ? (
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                            {students.map((student) => {
                                const displayName = student.name || `${student.firstName || ''} ${student.lastName || ''}`.trim() || 'Étudiant';
                                ...
                                return (
                                    <div key={student._id} className="group bg-white rounded-xl border border-gray-100 shadow-sm hover:shadow-md hover:border-blue-200 transition-all duration-200 overflow-hidden relative flex flex-col">
                                        ...
                                        <div className="px-6 pb-6 -mt-10 flex flex-col items-center flex-1">
                                            ...
                                            <h3 className="font-bold text-gray-900 text-lg text-center truncate w-full" title={displayName}>
                                                {displayName}
                                            </h3>
                    ...
                    {!loading && totalStudents > 0 && (
                        <div className="mt-8 flex justify-center items-center gap-2">
                            <button
                                ...
                                disabled={page === 1}
                                className="p-2 bg-white border border-gray-200 rounded-lg hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed transition"
                            >
                                <ChevronLeft size={20} />
                            </button>
