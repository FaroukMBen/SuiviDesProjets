...
import { Folder, Plus, ChevronRight, ChevronLeft, Calendar, CheckCircle2, Search, LayoutList, LayoutGrid, Grid3X3, Github } from 'lucide-react';
                                                                ...
                                                                <div className="flex items-center gap-3">
                                                                    {project.repositoryUrl && (
                                                                        <a 
                                                                            ...
                                                                            className="w-8 h-8 rounded-xl bg-gray-50 text-gray-500 border border-gray-100 flex items-center justify-center hover:bg-gray-900 hover:text-white hover:border-gray-900 transition-all duration-300"
