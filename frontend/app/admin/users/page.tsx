...
import { Plus, Edit2, Trash2, Search, Shield, GraduationCap, Briefcase } from 'lucide-react';
...
export default function AdminUsersPage() {
  ...
  return (
    <ProtectedRoute requireAdmin={true}> {/* Ajoute requireAdmin à ton ProtectedRoute si possible */}
