...
import { Plus, Edit2, Trash2, Search, User, Calendar, Eye } from 'lucide-react';
                ...
                {filtered.map((campaign) => (
                  <tr key={campaign._id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 text-right flex justify-end gap-2">
                      ...
                      <button onClick={() => handleDelete(campaign._id)} className="p-2 text-red-600 hover:bg-red-50 rounded">
                        <Trash2 size={18} />
                      </button>
                    </td>
                  </tr>
