...
export default function MilestonesPage() {
    ...
    const handleDelete = async (id: string) => {
        if (!await confirm({ title: "Supprimer le jalon", message: 'Êtes-vous sûr de vouloir supprimer ce jalon ?', type: "danger" })) return;
        try {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            fetchData();
            showToast(editingMilestone ? "Jalon modifié" : "Jalon créé", "success");
        } catch (err: any) {
